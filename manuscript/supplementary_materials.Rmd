...
```{r numStudiesPlot, fig.cap="Caption goes here...", fig.align="center", out.width="100%", fig.width=6, fig.height=3.2, fig.path='figs/', dev=c('png', 'pdf')}
...
```{r concernedPlot, warning=FALSE, fig.cap="Caption goes here...", fig.align="center", out.width="100%", fig.width=10, fig.height=4, fig.path='figs/', dev=c('png', 'pdf')}
