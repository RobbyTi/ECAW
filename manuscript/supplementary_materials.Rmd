...
Respondents had published a median of `r median(processed_all$n_studies, na.rm = TRUE)` (IQR `r round(quantile(processed_all$n_studies, .25, na.rm = TRUE))` to `r round(quantile(processed_all$n_studies, .75, na.rm = TRUE))`) studies using preexisting observational data (Supplementary Figure C1). They reported using the following programming languages or software packages: `r language_text_all` (Supplementary Table C1)\footnote[1]{Participants could select multiple responses to this survey question.}. `r pull(filter(concerned_all, support == "positive"), percentage)`% (`r pull(filter(concerned_all, support == "positive"), n)`/`r pull(filter(concerned_all, support == "positive"), n_sum)`) of participants reported being more concerned with research trustworthiness, bias, rigour, and reproducibility compared to what they think of as a typical research who uses preexisting observational data; `r pull(filter(concerned_all, support == "negative"), percentage)`% (`r pull(filter(concerned_all, support == "negative"), n)`/`r pull(filter(concerned_all, support == "negative"), n_sum)`) reported being less concerned (Supplementary Figure C2).
...
Most respondents agreed that studies that analyze preexisting observational datasets are trustworthy (`r pull(filter(typically_trustworthy_all, support == "positive"), percentage)`%; `r pull(filter(typically_trustworthy_all, support == "positive"), n)`/`r pull(filter(typically_trustworthy_all, support == "positive"), n_sum)`) and reproducible (`r pull(filter(typically_reproducible_all, support == "positive"), percentage)`%; `r pull(filter(typically_reproducible_all, support == "positive"), n)`/`r pull(filter(typically_reproducible_all, support == "positive"), n_sum)`) (Figure D2, top panel). At the same time, many agreed that a study using an ECAW would be _more_ trustworthy (`r pull(filter(ecaw_trustworthy_all, support == "positive"), percentage)`%; `r pull(filter(ecaw_trustworthy, support == "positive"), n)`/`r pull(filter(ecaw_trustworthy_all, support == "positive"), n_sum)`) and _more_ reproducible (`r pull(filter(ecaw_reproducible_all, support == "positive"), percentage)`%; `r pull(filter(ecaw_reproducible_all, support == "positive"), n)`/`r pull(filter(ecaw_reproducible_all, support == "positive"), n_sum)`) compared to a typical study using preexisting observational data (Figure 1, bottom panel).

```{r typicallyEcawPlotAll, warning=FALSE, fig.cap="(ref:typicallyEcawPlotAllCaption)", fig.align="center", out.width="100%", fig.width=12.8, fig.height=6, fig.path='figs/', dev=c('png', 'pdf')}
...
```{r methodPlotAll, warning=FALSE, fig.cap="(ref:methodPlotAllCaption)", fig.align="center", out.width="100%", fig.width=11, fig.height=4.5, fig.path='figs/', dev=c('png', 'pdf')}
...
(ref:methodPlotAllCaption) __Figure 2D. Responses to survey questions about the research practices of participants.__
...
```{r alspacPlotAll, warning=FALSE, message=FALSE, fig.cap="(ref:alspacPlotAllCaption)", fig.align="center", out.width="100%", fig.width=14, fig.height=5, fig.path='figs/', dev=c('png', 'pdf')}
# Check if there is any missing and don't understand responses separately
alspac_missing_all <-
  processed_all %>%
