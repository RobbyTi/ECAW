...
plot(concerned_likert_plot_data, digits = 1, text.size = 6, group.order = names(concerned_plot_data)) +
  labs(title = "Compared to what you think of as a typical researcher who uses preexisting observational\ndata in your field, how concerned are you with\nresearch trustworthiness, bias, rigour, and reproducibility ...") +
  theme(
