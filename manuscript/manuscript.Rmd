...
```{r typicallyEcawPlot, warning=FALSE, fig.cap="Caption goes here...", fig.align="center", out.width="100%", fig.width=12.8, fig.height=6, fig.path='figs/', dev=c('png', 'pdf')}
...
```{r methodPlot, warning=FALSE, fig.cap="Caption goes here...", fig.align="center", out.width="100%", fig.width=11, fig.height=4.5, fig.path='figs/', dev=c('png', 'pdf')}
...
```{r alspacPlot, warning=FALSE, message=FALSE, fig.cap="Caption goes here...", fig.align="center", out.width="100%", fig.width=14, fig.height=5, fig.path='figs/', dev=c('png', 'pdf')}
# Check if there is any missing and don't understand responses separately
alspac_missing_text <-
  processed %>%
...
# Create figure
plot(alspac_plot_likert_data, digits = 1, ordered = TRUE, text.size = 6) +
