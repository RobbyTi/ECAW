...
# source(here("preprocessing", "ecaw_source_raw_preprocessing.R"))

# loads raw data, performs preprocessing, saves processed datafiles
# source(here("preprocessing", "ecaw_raw_processed_preprocessing.R"))
```
...
```{r typicallyEcawPlot, warning=FALSE, fig.cap="Caption goes here...", fig.align="center", out.width="100%", fig.width=10, fig.height=6}
...
# Create figure
typically_plot <- 
  plot(typically_plot_data, digits = 1, ordered = FALSE, legend.position = "right", text.size = 4.7) +
...
# Create figure
ecaw_plot <- 
  plot(ecaw_plot_data, digits = 1, ordered = FALSE, legend.position = "right", text.size = 4.7) +
...
```{r methodPlot, warning=FALSE, fig.cap="Caption goes here...", fig.align="center", out.width="100%", fig.width=10, fig.height=4.5}
...
```{r alspacPlot, warning=FALSE, fig.cap="Caption goes here...", fig.align="center", out.width="100%", fig.width=10, fig.height=4, message=FALSE}
# Check if there is any missing and don't understand responses separately
alspac_missing_text <-
  processed %>% 
