...
We only include full responses in the final analysis as preregistered (see the full text of the preregistration [HERE](link)). There were `r dplyr::filter(raw, !finished)` respondents who did not finish the survey.
